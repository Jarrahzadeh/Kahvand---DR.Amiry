Public Class BaseData
    ...
    Sub ShowGrid()
        Dim Ado As New OleDb.OleDbDataAdapter("Select id as کد, Name as عنوان ,Price as مبلغ  From " + Tag, AdoCon)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            If Val(TxtId.Text) = 0 Then
                ...
                cmd.CommandText = "Insert into " + Tag + " (Name,Price) Values ('" + TxtName.Text + "','" + txtPrice.Text + "')"
                cmd.ExecuteNonQuery()
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        ...
        Dim cmd As New OleDb.OleDbCommand
        cmd.Connection = AdoCon
        cmd.CommandText = "Update " + Tag + " Set Name ='" + TxtName.Text + "',Price='" + txtPrice.Text + "' Where Id = " + TxtId.Text
        cmd.ExecuteNonQuery()
